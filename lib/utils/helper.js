...
/**
 * @method setApiVersion Sets the version of the API the SDK should use
 * @param {string} version Api version to use
 */
function setApiVersion(version) {
    if (version === constants.VERSIONS.DEFAULT)
        return VERSION = constants.VERSIONS.DEFAULT;

    if (version === constants.VERSIONS.Version_1_5_6)
        return VERSION = constants.VERSIONS.Version_1_5_6;
}


/**
 * @method getApiVersion Fetches version of the API the SDK is currently using
 * @returns {string} Current API versions
 */
...
function generateUrl(route, params){
    ...
    var path = serviceConfig.routes[VERSION][route];
