 ...
 * @description method Sets the version of the API the SDK should use
 * @memberOf Upstox
 * @instance
 * @param {string} version API version to use.
 */
Upstox.prototype.setApiVersion = function (version) {
 ...
 * @description method Fetches version of the API the SDK is currently using
 * @memberOf Upstox
 * @instance
 * @returns {string} Current API version
 */
Upstox.prototype.setApiVersion = function () {
    utils.getApiVersion();
};
...
Upstox.prototype.getOHLC = function(params){
    ...
    if (__this.getApiVersion() === constants.VERSIONS.DEFAULT)
        params["interval"] = constants.OHLC_INTERVALS_DEFAULT[params["interval"]];

    if (__this.getApiVersion() === constants.VERSIONS.Version_1_5_6)
 ...
 */
Upstox.prototype.getSubscriptions = function (type) {
    var __this = this;
    var HTTP_METHOD = "GET";
