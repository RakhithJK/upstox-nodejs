...
/**
 * @method getListOfSymbols
 * @description Function to get the the list of symbols user has subscribed as per the exchange.
 * @param params
 * @param {string} params.type optional parameter, the type of mode user has subscribed for, either FULL or LTP
 *                  if type is missing user get the list of symbols he has subscribed combined with both lto and full
 * @returns {res}
 */
Upstox.prototype.getListOfSymbols = function(params){
    var __this = this;
    var HTTP_METHOD = "GET";

    return utils.restify("getFeedsList", HTTP_METHOD, params, __this.auth)
};
